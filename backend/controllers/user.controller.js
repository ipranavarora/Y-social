...
export const followUnfollowUser = async(req, res)=>{
    try {
        ...
        res.status(500).json({error: error.message});
        console.log("Error in get followUnfollowUser", error.message);
    }
}
...
export const getSuggestedUsers = async (req, res) => {
    try {
        ...
        const filteredUsers = users.filter(user => user => !usersFollowedByMe.following.includes(user._id.toString()));
